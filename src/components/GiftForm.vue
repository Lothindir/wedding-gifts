    ...
    <div class="space-y-12 bg-white p-8 h-full">
      ...
      >
        <div>
          ...
          <h2 class="mt-2 text-base font-semibold leading-7 text-gray-900">Generic informations</h2>
        </div>
        ...
        <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
          ...
          <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
            <div class="sm:col-span-4">
              <label for="pieces" class="block text-sm font-medium leading-6 text-gray-900"
                >Parts</label
              >
              <div class="mt-2">
                <div
      ...
      >
        ...
        <h2 class="text-base font-semibold leading-7 text-gray-900">Add other languages</h2>
        <div class="sm:col-span-4">
...
const languages = defineModel<Tables<'gift_translations'>[] | TablesInsert<'gift_translations'>[]>(
  'languages',
  { required: true }
)
...
watch(
  ...
  () => {
    if (settingsStore.languages) {
      missingLanguages.value = settingsStore.languages.filter(
        (l) => !languages.value.find((t) => t.language === l)
      )
