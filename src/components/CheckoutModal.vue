        ...
        >
          ...
          >
            ...
            >
              ...
              <div
                class="mt-6 border-t border-gray-200 text-gray-700 font-bold text-center text-xl pt-6"
              >
              ...
              <div class="mt-6 border-t border-gray-200 pt-6">
                <fieldset>
                  ...
                  >
                    <RadioGroupOption
                      as="template"
                      v-for="deliveryMethod in settingsStore.payment_methods"
                      :key="deliveryMethod.id"
                      :value="deliveryMethod"
                      :aria-label="deliveryMethod.title"
                      :aria-description="`${deliveryMethod.title}`"
              ...
              <div class="text-sm text-gray-700 mt-2">
                <div class="flex flex-col align-middle">
                  <div
                    ...
                    v-for="method of selectedPaymentMethod.info"
                    :key="method"
                  >
                    <component
                      :is="getIcon(selectedPaymentMethod.info_icon)"
                      class="w-6 mr-4"
