      ...
      <div class="max-w-lg">
        ...
        <div class="mt-10">
          <a href="#" class="text-sm font-semibold leading-7 text-indigo-600"
            ><span aria-hidden="true">&larr;</span> {{ t('errors.home-message') }}</a
          >
        </div>
      </div>
    </main>
...
onMounted(() => {
  if (route.params.pathMatch === 'unknown locale') message.value = t('errors.404.language')
  else message.value = t('errors.404.description')
